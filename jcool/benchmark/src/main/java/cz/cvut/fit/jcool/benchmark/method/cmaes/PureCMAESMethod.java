package cz.cvut.fit.jcool.benchmark.method.cmaes;

import cz.cvut.fit.jcool.benchmark.stopcondition.EqualFunValuesStopCondition;
import cz.cvut.fit.jcool.benchmark.stopcondition.ConditionCovStopCondition;
import cz.cvut.fit.jcool.benchmark.stopcondition.TolXStopCondition;
import cz.cvut.fit.jcool.benchmark.stopcondition.SimpleStopCondition;
import cz.cvut.fit.jcool.benchmark.stopcondition.NoEffectAxisStopCondition;
import cz.cvut.fit.jcool.benchmark.stopcondition.TolFunStopCondition;
import cz.cvut.fit.jcool.benchmark.stopcondition.NoEffectCoordStopCondition;
