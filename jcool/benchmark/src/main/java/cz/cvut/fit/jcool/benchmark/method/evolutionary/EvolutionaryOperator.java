package cz.cvut.fit.jcool.benchmark.method.evolutionary;

import cz.cvut.fit.jcool.core.FunctionDynamics;
...
public interface EvolutionaryOperator extends FunctionDynamics {
     ...
     * @throws cz.cvut.fit.jcool.core.OptimizationException if some parameter is set incorrectly or input populations does not meet required criteria.
     */
