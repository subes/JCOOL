...
import cz.cvut.fit.jcool.ui.model.PropertyTable;
...
public class ExperimentDetails extends JPanel {
    ...
    private cz.cvut.fit.jcool.ui.model.ExperimentSetup experiment;
    private PropertyExtractor extractor;
    private cz.cvut.fit.jcool.ui.model.ExperimentDetails model;

    public void setExperiment(cz.cvut.fit.jcool.ui.model.ExperimentSetup experiment) {
    ...
    public void setModel(cz.cvut.fit.jcool.ui.model.ExperimentDetails model) {
        this.model = model;
    }

    public void initComponents() {
        function = new Detail("function", extractor, cz.cvut.fit.jcool.ui.view.ExperimentDetails.Detail.Type.TABLE);
        experiment.addPropertyChangeListener(function);

        methodComponents = new DelegatedDetail("methodComponents", extractor, cz.cvut.fit.jcool.ui.view.ExperimentDetails.Detail.Type.LIST, this.model);
        model.addPropertyChangeListener(methodComponents);

        method = new DelegatedDetail("method", extractor, cz.cvut.fit.jcool.ui.view.ExperimentDetails.Detail.Type.TABLE, this.model);
        model.addPropertyChangeListener(method);

        solver = new Detail("solver", extractor, cz.cvut.fit.jcool.ui.view.ExperimentDetails.Detail.Type.TABLE);
        experiment.addPropertyChangeListener(solver);

        conditions = new Detail("stopconditions", extractor, cz.cvut.fit.jcool.ui.view.ExperimentDetails.Detail.Type.LIST);
        experiment.addPropertyChangeListener(conditions);

        visualizations = new Detail("visualizations", extractor, cz.cvut.fit.jcool.ui.view.ExperimentDetails.Detail.Type.LIST);
