 ...
 * the optimization process as well as optimization {@link Statistics}
...
public final class OptimizationResults {
     ...
     * @param metConditions      stop conditions causing the optimization
     *                           process to stop
     */
     ...
     *
     * @return solution represented by the telemetry after the optimization
     *         process terminated
     */
     ...
     *
     * @return function value evaluation statistics gathered dring optimization
     *         process.
     */
    ...
    /**
     * Retrieve the number of iterations it took to stop the optimization
     * process
    ...
    /**
     * Retrieve a list of stop conditions that caused the optimization process
     * to stop.
     *
